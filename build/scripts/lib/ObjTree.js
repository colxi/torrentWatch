...
(function (global) {
				...
				// ========================================================================
				if (typeof XML == 'undefined') XML = function XML() {};
				...
				XML.ObjTree.prototype.parseDOM = function (root) {
								...
								if (this.soft_arrays) {
												var augmentObject = function augmentObject(obj) {
				...
				XML.ObjTree.prototype.hash_to_xml = function (name, tree) {
								...
								for (var key in tree) {
												...
												if (key.charAt(0) != this.attr_prefix) {
																...
																} else if ((typeof val === 'undefined' ? 'undefined' : _typeof(val)) == "object" && val.constructor == Array) {
...
// ========================================================================
*/
//# sourceMappingURL=ObjTree.js.map
