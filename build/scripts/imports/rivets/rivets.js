...
(function () {
  function t(t, i, s, h) {
    ...
    this.options = h || {}, this.options.adapters = this.options.adapters || {}, this.obj = t, this.keypath = e, this.callback = s, this.objectPath = [], this.parse(), i(this.target = this.realize()) && this.set(!0, this.key, this.target, this.callback);
  }function i(t) {
    ...
    var s,
        h,
        a = [],
        o = { i: i, path: "" };for (s = 0; s < t.length; s++) {
      h = t.charAt(s), ~e.indexOf(h) ? (a.push(o), o = { i: h, path: "" }) : o.path += h;
    }return a.push(o), a;
  }, e.prototype.parse = function () {
    var i,
        h,
        a = this.interfaces();a.length || s("Must define at least one adapter interface."), ~a.indexOf(this.keypath[0]) ? (i = this.keypath[0], h = this.keypath.substr(1)) : ("undefined" == typeof (i = this.options.root || t.root) && s("Must define a default root adapter."), h = this.keypath), this.tokens = e.tokenize(h, a, i), this.key = this.tokens.pop();
  }, e.prototype.realize = function () {
    var t,
        e = this.obj,
        s = !1;return this.tokens.forEach(function (h, a) {
      i(e) ? ("undefined" != typeof this.objectPath[a] ? e !== (t = this.objectPath[a]) && (this.set(!1, h, t, this.update.bind(this)), this.set(!0, h, e, this.update.bind(this)), this.objectPath[a] = e) : (this.set(!0, h, e, this.update.bind(this)), this.objectPath[a] = e), e = this.get(h, e)) : (s === !1 && (s = a), (t = this.objectPath[a]) && this.set(!1, h, t, this.update.bind(this)));
    }, this), s !== !1 && this.objectPath.splice(s), e;
  }, e.prototype.update = function () {
    var t, e;(t = this.realize()) !== this.target && (i(this.target) && this.set(!1, this.key, this.target, this.callback), i(t) && this.set(!0, this.key, t, this.callback), e = this.value(), this.target = t, this.value() !== e && this.callback());
    ...
    var h = t ? "observe" : "unobserve";this.adapter(e)[h](i, e.path, s);
    ...
    var t;this.tokens.forEach(function (e, i) {
  ...
  var t,
    ...
    for (var e = 0, i = this.length; i > e; e++) {
      if (e in this && this[e] === t) return e;
        ...
        var i, n, s, r;null == e && (e = {});for (s in e) {
          if (r = e[s], "binders" === s || "components" === s || "formatters" === s || "adapters" === s) for (n in r) {
            i = r[n], t[s][n] = i;
          } else t["public"][s] = r;
        }
      }, bind: function bind(e, i, n) {
        var s;return null == i && (i = {}), null == n && (n = {}), s = new t.View(e, i, n), s.bind(), s;
      }, init: function init(e, i, n) {
        var s, r, o;if (null == n && (n = {}), null == i && (i = document.createElement("div")), e = t["public"].components[e], r = e.template.call(this, i), r instanceof HTMLElement) {
          for (; i.firstChild;) {
            i.removeChild(i.firstChild);
          }i.appendChild(r);
        } else i.innerHTML = r;return s = e.initialize.call(this, i, n), o = new t.View(i, s), o.bind(), o;
      } } }, window.jQuery || window.$ ? (n = "on" in jQuery.prototype ? ["on", "off"] : ["bind", "unbind"], e = n[0], i = n[1], t.Util = { bindEvent: function bindEvent(t, i, n) {
      return jQuery(t)[e](i, n);
    }, unbindEvent: function unbindEvent(t, e, n) {
      return jQuery(t)[i](e, n);
    }, getInputValue: function getInputValue(t) {
      var e;return e = jQuery(t), "checkbox" === e.attr("type") ? e.is(":checked") : e.val();
      ...
      var e, i, n, s;if ("checkbox" === t.type) return t.checked;if ("select-multiple" === t.type) {
        for (s = [], i = 0, n = t.length; n > i; i++) {
          e = t[i], e.selected && s.push(e.value);
        }return s;
      }return t.value;
    ...
    function t() {}return t.types = { text: 0, binding: 1 }, t.parse = function (t, e) {
      var i, n, s, r, o, u, l;for (u = [], r = t.length, i = 0, n = 0; r > n;) {
        if (i = t.indexOf(e[0], n), 0 > i) {
          ...
          o = t.slice(n - e[1].length), s = u[u.length - 1], (null != s ? s.type : void 0) === this.types.text ? s.value += o : u.push({ type: this.types.text, value: o });break;
        }l = t.slice(n, i).trim(), u.push({ type: this.types.binding, value: l }), n = i + e[1].length;
      }return u;
    }, t;
  }(), t.View = function () {
    function e(e, i, n) {
      var r, o, u, l, h, a, p, d, c, f, b, v, y;for (this.els = e, this.models = i, null == n && (n = {}), this.update = s(this.update, this), this.publish = s(this.publish, this), this.sync = s(this.sync, this), this.unbind = s(this.unbind, this), this.bind = s(this.bind, this), this.select = s(this.select, this), this.traverse = s(this.traverse, this), this.build = s(this.build, this), this.buildBinding = s(this.buildBinding, this), this.bindingRegExp = s(this.bindingRegExp, this), this.options = s(this.options, this), this.els.jquery || this.els instanceof Array || (this.els = [this.els]), c = t.extensions, h = 0, p = c.length; p > h; h++) {
        if (o = c[h], this[o] = {}, n[o]) {
          f = n[o];for (r in f) {
            u = f[r], this[o][r] = u;
          }
        ...
        o = v[a], this[o] = null != (y = n[o]) ? y : t["public"][o];
      }this.build();
    }return e.prototype.options = function () {
      var e, i, n, s, r;for (i = {}, r = t.extensions.concat(t.options), n = 0, s = r.length; s > n; n++) {
        e = r[n], i[e] = this[e];
      }return i;
    }, e.prototype.bindingRegExp = function () {
      return new RegExp("^" + this.prefix + "-");
    }, e.prototype.buildBinding = function (e, i, n, s) {
      var r, o, u, l, h, a, p;return h = {}, p = function () {
        var t, e, i, n;for (i = s.match(/((?:'[^']*')*(?:(?:[^\|']*(?:'[^']*')+[^\|']*)+|[^\|]+))|^$/g), n = [], t = 0, e = i.length; e > t; t++) {
          a = i[t], n.push(a.trim());
        }return n;
      }(), r = function () {
      ...
      }(), l = r.shift(), h.formatters = p, (u = r.shift()) && (h.dependencies = u.split(/\s+/)), this.bindings.push(new t[e](this, i, n, l, h));
    }, e.prototype.build = function () {
      var e, i, n, s, r;for (this.bindings = [], i = function (e) {
        return function (n) {
          var s, r, o, u, l, h, a, p, d, c, f, b, v;if (3 === n.nodeType) {
          ...
          } else 1 === n.nodeType && (s = e.traverse(n));if (!s) for (v = function () {
            var t, e, i, s;for (i = n.childNodes, s = [], t = 0, e = i.length; e > t; t++) {
              u = i[t], s.push(u);
            }return s;
      ...
      }(this), r = this.els, n = 0, s = r.length; s > n; n++) {
        e = r[n], i(e);
      ...
      var i, n, s, r, o, u, l, h, a, p, d, c, f, b, v, y;for (r = this.bindingRegExp(), o = "SCRIPT" === e.nodeName || "STYLE" === e.nodeName, b = e.attributes, p = 0, c = b.length; c > p; p++) {
        if (i = b[p], r.test(i.name)) {
          if (h = i.name.replace(r, ""), !(s = this.binders[h])) {
            v = this.binders;for (u in v) {
              a = v[u], "*" !== u && -1 !== u.indexOf("*") && (l = new RegExp("^" + u.replace(/\*/g, ".+") + "$"), l.test(h) && (s = a));
            }
          }s || (s = this.binders["*"]), s.block && (o = !0, n = [i]);
        }
      }for (y = n || e.attributes, d = 0, f = y.length; f > d; d++) {
        i = y[d], r.test(i.name) && (h = i.name.replace(r, ""), this.buildBinding("Binding", e, h, i.value));
      ...
      var e, i, n, s, r;for (s = this.bindings, r = [], i = 0, n = s.length; n > i; i++) {
        e = s[i], t(e) && r.push(e);
      }return r;
      ...
      var e, i, n, s, r, o;null == t && (t = {});for (i in t) {
        n = t[i], this.models[i] = n;
      }for (o = this.bindings, s = 0, r = o.length; r > s; s++) {
        e = o[s], "function" == typeof e.update && e.update(t);
      }
    }, e;
  }(), t.Binding = function () {
    function e(t, e, i, n, r) {
      this.view = t, this.el = e, this.type = i, this.keypath = n, this.options = null != r ? r : {}, this.getValue = s(this.getValue, this), this.update = s(this.update, this), this.unbind = s(this.unbind, this), this.bind = s(this.bind, this), this.publish = s(this.publish, this), this.sync = s(this.sync, this), this.set = s(this.set, this), this.eventHandler = s(this.eventHandler, this), this.formattedValue = s(this.formattedValue, this), this.parseTarget = s(this.parseTarget, this), this.observe = s(this.observe, this), this.setBinder = s(this.setBinder, this), this.formatters = this.options.formatters || [], this.dependencies = [], this.formatterObservers = {}, this.model = void 0, this.setBinder();
      ...
      var e;return e = t.TypeParser.parse(this.keypath), 0 === e.type ? this.value = e.value : (this.observer = this.observe(this.view.models, this.keypath, this.sync), this.model = this.observer.target);
    }, e.prototype.formattedValue = function (e) {
      var i, n, s, o, u, l, h, a, p, d, c, f, b, v, y;for (v = this.formatters, o = d = 0, f = v.length; f > d; o = ++d) {
        for (u = v[o], s = u.match(/[^\s']+|'([^']|'[^\s])*'|"([^"]|"[^\s])*"/g), l = s.shift(), u = this.view.formatters[l], s = function () {
          var e, i, r;for (r = [], e = 0, i = s.length; i > e; e++) {
            n = s[e], r.push(t.TypeParser.parse(n));
          }return r;
        }(), a = [], i = c = 0, b = s.length; b > c; i = ++c) {
          n = s[i], a.push(0 === n.type ? n.value : ((p = this.formatterObservers)[o] || (p[o] = {}), (h = this.formatterObservers[o][i]) ? void 0 : (h = this.observe(this.view.models, n.value, this.sync), this.formatterObservers[o][i] = h), h.value()));
        }(null != u ? u.read : void 0) instanceof Function ? e = (y = u.read).call.apply(y, [this.model, e].concat(r.call(a))) : u instanceof Function && (e = u.call.apply(u, [this.model, e].concat(r.call(a))));
      }return e;
      ...
      var t, e;return this.set(function () {
        var i, n, s, r, o, u, l;if (this.observer) {
          if (this.model !== this.observer.target) {
            for (o = this.dependencies, i = 0, s = o.length; s > i; i++) {
              e = o[i], e.unobserve();
            }if (this.dependencies = [], null != (this.model = this.observer.target) && (null != (u = this.options.dependencies) ? u.length : void 0)) for (l = this.options.dependencies, n = 0, r = l.length; r > n; n++) {
      ...
      var t, e, i, n, s, o, u, l, h;if (this.observer) {
        for (n = this.getValue(this.el), u = this.formatters.slice(0).reverse(), s = 0, o = u.length; o > s; s++) {
          e = u[s], t = e.split(/\s+/), i = t.shift(), (null != (l = this.view.formatters[i]) ? l.publish : void 0) && (n = (h = this.view.formatters[i]).publish.apply(h, [n].concat(r.call(t))));
        }return this.observer.setValue(n);
      }
    }, e.prototype.bind = function () {
      var t, e, i, n, s, r, o;if (this.parseTarget(), null != (s = this.binder.bind) && s.call(this, this.el), null != this.model && (null != (r = this.options.dependencies) ? r.length : void 0)) for (o = this.options.dependencies, i = 0, n = o.length; n > i; i++) {
        t = o[i], e = this.observe(this.model, t, this.sync), this.dependencies.push(e);
      }return this.view.preloadData ? this.sync() : void 0;
    }, e.prototype.unbind = function () {
      var t, e, i, n, s, r, o, u, l, h;for (null != (o = this.binder.unbind) && o.call(this, this.el), null != (u = this.observer) && u.unobserve(), l = this.dependencies, s = 0, r = l.length; r > s; s++) {
        n = l[s], n.unobserve();
    ...
    function i(e, i, n) {
      var r, o, u, h, a, p, d, c;for (this.view = e, this.el = i, this.type = n, this.unbind = s(this.unbind, this), this.bind = s(this.bind, this), this.locals = s(this.locals, this), this.component = this.view.components[this.type], this["static"] = {}, this.observers = {}, this.upstreamObservers = {}, o = e.bindingRegExp(), d = this.el.attributes || [], a = 0, p = d.length; p > a; a++) {
        r = d[a], o.test(r.name) || (u = this.camelCase(r.name), h = t.TypeParser.parse(r.value), l.call(null != (c = this.component["static"]) ? c : [], u) >= 0 ? this["static"][u] = r.value : 0 === h.type ? this["static"][u] = h.value : this.observers[u] = r.value);
      }
      ...
      var t, e, i, n, s, r;i = {}, s = this["static"];for (t in s) {
        n = s[t], i[t] = n;
      }r = this.observers;for (t in r) {
        e = r[t], i[t] = e.value();
      }return i;
      ...
      var e, i, n, s, r, o, u, l, h, a, p, d, c, f, b, v, y, m, g, w;if (!this.bound) {
        ...
        for (this.el.innerHTML = this.component.template.call(this), u = this.component.initialize.call(this, this.el, this.locals()), this.el._bound = !0, o = {}, b = t.extensions, a = 0, d = b.length; d > a; a++) {
          if (r = b[a], o[r] = {}, this.component[r]) {
            v = this.component[r];for (e in v) {
              l = v[e], o[r][e] = l;
            }
          }y = this.view[r];for (e in y) {
            l = y[e], null == (h = o[r])[e] && (h[e] = l);
          }
        }for (m = t.options, p = 0, c = m.length; c > p; p++) {
          r = m[p], o[r] = null != (g = this.component[r]) ? g : this.view[r];
          ...
          s = w[i], this.upstreamObservers[i] = this.observe(this.componentView.models, i, function (t) {
            return function (e, i) {
              return function () {
      ...
      var t, e, i, n, s;i = this.upstreamObservers;for (t in i) {
        e = i[t], e.unobserve();
      }n = this.observers;for (t in n) {
        e = n[t], e.unobserve();
      }return null != (s = this.componentView) ? s.unbind.call(this) : void 0;
    }, i;
    ...
    }return u(e, t), e.prototype.binder = { routine: function routine(t, e) {
    ...
    return t.disabled = !!e;
      ...
      var i, n, s, r, o, u, h;if ("INPUT" === t.tagName && "radio" === t.type) return t.setAttribute("value", e);if (null != window.jQuery) {
        if (t = jQuery(t), (null != e ? e.toString() : void 0) !== (null != (r = t.val()) ? r.toString() : void 0)) return t.val(null != e ? e : "");
      } else if ("select-multiple" === t.type) {
        if (null != e) {
          for (h = [], n = 0, s = t.length; s > n; n++) {
            i = t[n], h.push(i.selected = (o = i.value, l.call(e, o) >= 0));
          }return h;
        }
      ...
      var n, s, r, o;if (!!i == !this.bound) {
        if (i) {
          r = {}, o = this.view.models;for (n in o) {
            s = o[n], r[n] = s;
      ...
      var e, i, n, s, r;if (null == this.marker) e = [this.view.prefix, this.type].join("-").replace("--", "-"), this.marker = document.createComment(" rivets: " + this.type + " "), this.iterated = [], t.removeAttribute(e), t.parentNode.insertBefore(this.marker, t), t.parentNode.removeChild(t);else for (r = this.iterated, n = 0, s = r.length; s > n; n++) {
        i = r[n], i.bind();
      }
    }, unbind: function unbind() {
      ...
      var n, s, r, o, u, l, h, a, p, d, c, f, b, v, y, m, g, w, k, x;if (h = this.args[0], i = i || [], this.iterated.length > i.length) for (w = Array(this.iterated.length - i.length), f = 0, y = w.length; y > f; f++) {
        r = w[f], c = this.iterated.pop(), c.unbind(), this.marker.parentNode.removeChild(c.els[0]);
      }for (o = b = 0, m = i.length; m > b; o = ++b) {
        if (l = i[o], s = { index: o }, s[t["public"].iterationAlias(h)] = o, s[h] = l, null == this.iterated[o]) {
          k = this.view.models;for (u in k) {
            l = k[u], null == s[u] && (s[u] = l);
          }p = this.iterated.length ? this.iterated[this.iterated.length - 1].els[0] : this.marker, a = this.view.options(), a.preloadData = !0, d = e.cloneNode(!0), c = new t.View(d, s, a), c.bind(), this.iterated.push(c), this.marker.parentNode.insertBefore(d, p.nextSibling);
        } else this.iterated[o].models[h] !== l && this.iterated[o].update(s);
      }if ("OPTION" === e.nodeName) for (x = this.view.bindings, v = 0, g = x.length; g > v; v++) {
        n = x[v], n.el === this.marker.parentNode && "value" === n.type && n.sync();
      }
    }, update: function update(t) {
      var e, i, n, s, r, o, u;e = {};for (i in t) {
        n = t[i], i !== this.args[0] && (e[i] = n);
      }for (u = this.iterated, r = 0, o = u.length; o > r; r++) {
        s = u[r], s.update(e);
      }
    ...
    var t, e;return e = arguments[0], t = 2 <= arguments.length ? r.call(arguments, 1) : [], e.call.apply(e, [this].concat(r.call(t)));
      ...
      var i, n, s;return n = t[e], i = this.weakReference(t), s = this.weakmap, t[e] = function () {
        var e, r, o, u, l, h, a, p, d, c;u = n.apply(t, arguments), a = i.pointers;for (o in a) {
          for (r = a[o], c = null != (p = null != (d = s[o]) ? d.callbacks[r] : void 0) ? p : [], l = 0, h = c.length; h > l; l++) {
            e = c[l], e();
          }
        }return u;
      };
    }, observeMutations: function observeMutations(t, e, i) {
      var n, s, r, o, u, h;if (Array.isArray(t)) {
        if (r = this.weakReference(t), null == r.pointers) for (r.pointers = {}, s = ["push", "pop", "shift", "unshift", "sort", "reverse", "splice"], u = 0, h = s.length; h > u; u++) {
          n = s[u], this.stubFunction(t, n);
        }if (null == (o = r.pointers)[e] && (o[e] = []), l.call(r.pointers[e], i) < 0) return r.pointers[e].push(i);
      }
    }, unobserveMutations: function unobserveMutations(t, e, i) {
      var n, s, r;return Array.isArray(t) && null != t[this.id] && (s = this.weakmap[t[this.id]]) && (r = s.pointers[e]) ? ((n = r.indexOf(i)) >= 0 && r.splice(n, 1), r.length || delete s.pointers[e], this.cleanupWeakReference(s, t[this.id])) : void 0;
    }, observe: function observe(t, e, i) {
      var n, s, r;return n = this.weakReference(t).callbacks, null == n[e] && (n[e] = [], s = Object.getOwnPropertyDescriptor(t, e), (null != s ? s.get : void 0) || (null != s ? s.set : void 0) || (r = t[e], Object.defineProperty(t, e, { enumerable: !0, get: function get() {
          return r;
        }, set: function (i) {
          return function (s) {
            var o, u, l, h, a;if (s !== r && (i.unobserveMutations(r, t[i.id], e), r = s, u = i.weakmap[t[i.id]])) {
              if (n = u.callbacks, n[e]) for (a = n[e], l = 0, h = a.length; h > l; l++) {
                o = a[l], o();
              }return i.observeMutations(s, t[i.id], e);
            }
          };
        }(this) }))), l.call(n[e], i) < 0 && n[e].push(i), this.observeMutations(t[e], t[this.id], e);
    }, unobserve: function unobserve(t, e, i) {
      var n, s, r;return (r = this.weakmap[t[this.id]]) && (n = r.callbacks[e]) ? ((s = n.indexOf(i)) >= 0 && (n.splice(s, 1), n.length || delete r.callbacks[e]), this.unobserveMutations(t[e], t[this.id], e), this.cleanupWeakReference(r, t[this.id])) : void 0;
